    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <form action="<?= site_url("Guest/login") ?>" method="post">
                ...
                <input type="text" class="form-control" name="username" placeholder="Unesite svoje ime..." value="<?= old('username') ?>">
                <br>

                <label for="password" class="form-label">Šifra: </label>
                <input type="password" class="form-control" name="password" placeholder="Unesite svoju šifru..." value="<?= old('password') ?>">
                <br>
